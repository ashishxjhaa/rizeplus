...
export default function Home() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden w-full bg-neutral-900 flex flex-col items-center justify-center py-20">
      ...
      <div className="mt-10">
        <button onClick={handleRoast} disabled={loading} className="flex items-center justify-center gap-2 border bg-[#E6E6E6] hover:bg-[#F6F6F6] h-9 px-8 text-black tracking-wide rounded-lg font-medium text-sm cursor-pointer disabled:opacity-50">
